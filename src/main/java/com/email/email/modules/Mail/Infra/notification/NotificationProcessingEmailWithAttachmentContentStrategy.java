...
public class NotificationProcessingEmailWithAttachmentContentStrategy implements EmailContentStrategy<NotificationEmailBody> {

    @Override
    public String createContent(NotificationEmailBody filteredBody) {
        StringBuilder contentBuilder = new StringBuilder();
        contentBuilder.append("Olá prezado cliente! \n");
        contentBuilder.append("estamos encaminhando seu anexo logo abaixo: \n");
